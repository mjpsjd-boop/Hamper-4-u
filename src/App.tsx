...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#1f020c] via-[#0b0104] to-[#290308] text-stone-100 font-sans flex flex-col relative overflow-x-hidden selection:bg-[#D4AF37] selection:text-black pb-12">
      ...
      <div className="bg-[#122414] text-white py-2.5 px-4 border-b border-[#D4AF37]/35 flex items-center justify-center text-center overflow-hidden relative z-20 shadow-[0_2px_15px_rgba(45,90,39,0.3)]">
        <div className="max-w-4xl flex flex-wrap items-center justify-center gap-x-8 gap-y-1 text-[11px] tracking-widest uppercase font-semibold">
          ...
          <span className="hidden lg:inline text-[#D4AF37]/50">•</span>
      ...
      <header className="bg-[#09170A]/85 backdrop-blur-xl sticky top-0 z-30 border-b border-[#D4AF37]/20 shadow-[0_4px_30px_rgba(0,0,0,0.4)]">
        <div className="max-w-7xl mx-auto px-4 py-4 md:py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col text-center md:text-left cursor-pointer" onClick={() => setActiveTab("catalog")}>
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              <h1 className="font-serif text-2xl md:text-3xl tracking-widest font-black text-white hover:text-[#D4AF37] transition duration-300 drop-shadow-[0_2px_6px_rgba(212,175,55,0.2)]">
                HAMPERS<span className="text-[#D4AF37]">_</span>4<span className="text-[#D4AF37]">_</span>YOU
              </h1>
            </div>
            <p className="font-sans text-[10px] uppercase tracking-widest text-[#D4AF37] font-bold flex items-center justify-center md:justify-start gap-1">
              by tasdiqa 🌸 luxury curation & craft preservation
            </p>
          </div>

          <div className="bg-[#122414] border border-[#D4AF37]/50 rounded-xl p-1 flex items-center gap-1 md:gap-1.5 shadow-[0_4px_25px_rgba(0,0,0,0.5)]">
            <button
              ...
              className={`px-3 md:px-4 py-2 rounded-lg font-serif text-[10px] md:text-xs uppercase tracking-wider font-bold transition-all duration-300 cursor-pointer ${
                activeTab === "catalog"
                  ? "bg-[#D4AF37] text-[#071308] font-black shadow-md scale-102"
                  : "text-[#D4AF37]/80 hover:text-white hover:bg-white/5"
              }`}
            >
              Collection Bespoke
            </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative bg-[#112413] border border-[#D4AF37]/30 p-2.5 rounded-full hover:bg-[#1E3B20] active:scale-95 transition cursor-pointer flex items-center justify-center text-[#D4AF37] shadow-[0_0_10px_rgba(0,0,0,0.5)] group"
              title="View Gilded Wishlist"
            >
              <Heart className={`w-5 h-5 group-hover:scale-110 transition-all duration-300 ${wishlist.length > 0 ? "fill-[#D4AF37] text-[#D4AF37]" : "text-[#D4AF37]"}`} />
              {wishlist.length > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#D4AF37] text-[#071308] font-sans text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-black border-2 border-[#112413] animate-pulse shadow-[0_0_8px_rgba(212,175,55,0.6)]">
                  {wishlist.length}
                </span>
              )}
            </button>
            ...
            <button
              ...
              className="bg-[#122A14]/80 text-[#D4AF37] hover:text-white hover:bg-[#2D5A27] font-sans text-[10px] uppercase tracking-widest font-black py-2.5 px-4 rounded-full border border-[#D4AF37]/35 hover:border-[#D4AF37] transition duration-300 cursor-pointer shadow-sm flex items-center gap-1.5"
              title="Separate Admin back-office authentication panel"
            >
              <Award className="w-3.5 h-3.5 text-[#D4AF37]" strokeWidth={2.5} /> Atelier Access 🔐
            </button>
          </div>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden py-12 md:py-20 border-b border-[#D4AF37]/25 bg-[#09150B]/60 shadow-[inset_0_0_50px_rgba(0,0,0,0.6)]">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          
          {/* Left Text */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#112412] border-2 border-[#D4AF37]/35 text-[10px] font-bold text-[#D4AF37] tracking-widest uppercase font-sans shadow-[0_0_20px_rgba(212,175,55,0.15)] animate-pulse">
              <Sparkles className="w-3.5 h-3.5 text-[#D4AF37]" /> Preserving Timeless Lifelines with Bespoke Luxury
            </span>
            <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-white leading-tight font-black tracking-wide">
              ...
              <span className="italic font-normal text-[#D4AF37] drop-shadow-[0_2px_10px_rgba(212,175,55,0.3)]">Memory Artifacts & Keepsakes</span>
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-3">
              <button
                ...
                className="bg-[#2D5A27] text-white px-8 py-4 rounded-full font-serif tracking-widest font-black text-xs uppercase hover:bg-emerald-950 transition duration-300 cursor-pointer flex items-center gap-2 border border-[#D4AF37] btn-gold-glint shadow-[0_4px_25px_rgba(45,90,39,0.5)]"
              >
                Browse Catalog Modules <ChevronRight className="w-4 h-4 text-[#D4AF37]" />
              </button>
              <button
                onClick={() => { setActiveTab("planner"); scrollIntoSection("planner-entry-anchor"); }}
                className="bg-[#122413] text-[#D4AF37] border-2 border-[#D4AF37]/40 hover:bg-[#1C3A1F] hover:text-white px-8 py-4 rounded-full font-sans text-xs font-black uppercase tracking-widest transition duration-300 cursor-pointer shadow-md"
              >
            ...
            <div className="pt-6 grid grid-cols-3 gap-4 border-t border-[#D4AF37]/20 max-w-md mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
                <span className="block font-serif text-xl md:text-3xl font-black text-white">4.9 ★</span>
                <span className="font-sans text-[10px] uppercase tracking-widest text-[#D4AF37]/80">Client Rating</span>
              </div>
              <div className="text-center lg:text-left">
                ...
                <span className="font-sans text-[10px] uppercase tracking-widest text-[#D4AF37]/80">Direct Cured</span>
              </div>
              <div className="text-center lg:text-left">
                <span className="block font-serif text-xl md:text-3xl font-black text-white">0%</span>
                <span className="font-sans text-[10px] uppercase tracking-widest text-[#D4AF37]/80">Broker Markup</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex flex-col items-center">
            ...
            <div className="relative w-80 md:w-96 aspect-[4/5] rounded-[2rem] bg-[#0E1F10] border-2 border-[#D4AF37] p-3 shadow-[0_0_40px_rgba(0,0,0,0.8)] group transition-all duration-500 hover:scale-[1.02]">
              {/* Slideshow Image */}
              <div className="w-full h-full rounded-[1.7rem] overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-5">
                  <span className="text-[10px] text-[#D4AF37] uppercase tracking-widest font-black mb-1">
              ...
              <div className="absolute top-5 left-5 text-[#D4AF37]/50 text-xs animate-spin-slow">✦</div>
              <div className="absolute top-5 right-5 text-[#D4AF37]/50 text-xs">✦</div>

              {/* Absolute label badge */}
              <div className="absolute -bottom-4 bg-gradient-to-r from-[#D4AF37] to-[#B88E53] text-[#071308] py-1.5 px-5 rounded-full shadow-xl text-[10px] tracking-widest uppercase font-black">
                Active Slide: 0{activeHeroSlide + 1} ⚜️
              </div>
            </div>

            {/* Slideshow controller buttons under image */}
            <div className="flex gap-2.5 mt-8 items-center bg-[#112413] border border-[#D4AF37]/30 px-4 py-2 rounded-full shadow-lg">
              <button 
                onClick={() => setActiveHeroSlide(0)} 
                className={`w-3 h-3 rounded-full transition-all duration-300 ${activeHeroSlide === 0 ? "bg-[#D4AF37] scale-125" : "bg-stone-500 hover:bg-stone-300"}`}
                title="Platter showcases"
              />
              <button 
                onClick={() => setActiveHeroSlide(1)} 
                className={`w-3 h-3 rounded-full transition-all duration-300 ${activeHeroSlide === 1 ? "bg-[#D4AF37] scale-125" : "bg-stone-500 hover:bg-stone-300"}`}
                title="Resin clocks"
              />
              <button 
                onClick={() => setActiveHeroSlide(2)} 
                className={`w-3 h-3 rounded-full transition-all duration-300 ${activeHeroSlide === 2 ? "bg-[#D4AF37] scale-125" : "bg-stone-500 hover:bg-stone-300"}`}
                title="Nikah frames"
              />
              <span className="text-[10px] text-stone-400 font-mono tracking-widest uppercase ml-2 select-none border-l border-[#D4AF37]/20 pl-2">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 flex-1 w-full" id="catalog-anchor-main">
        ...
        {/* Navigation Tabs bar */}
        <div className="flex justify-center border-b border-[#D4AF37]/25 mb-8 max-w-md mx-auto gap-2 relative z-10 bg-[#122414]/70 p-1.5 rounded-2xl border border-[#D4AF37]/15 shadow-md">
          <button
            onClick={() => setActiveTab("catalog")}
            className={`flex-1 py-2.5 text-xs uppercase tracking-widest font-black text-center focus:outline-none transition-all duration-300 cursor-pointer rounded-xl ${
              activeTab === "catalog"
                ? "bg-[#2D5A27] text-white shadow-sm border border-[#D4AF37]/45"
        ...
        {activeTab === "catalog" && (
          <div id="collections-main">
                ...
                return (
                  <button
                    ...
                    className={`relative group shrink-0 w-28 h-28 md:w-32 md:h-32 rounded-2xl overflow-hidden border-2 transition-all duration-500 shadow-md flex flex-col justify-end p-3 cursor-pointer ${
                      isActive
                        ? "border-[#D4AF37] scale-105 ring-4 ring-[#D4AF37]/20 shadow-xl"
                        : "border-[#D1A39E]/25 hover:border-[#D4AF37]/50 hover:shadow-lg hover:-translate-y-1"
                    }`}
                  >
                    ...
                    {cat.badge && (
                      <span className="absolute top-2 right-2 z-10 bg-[#D4AF37] text-white text-[8px] font-sans font-bold tracking-widest uppercase px-1.5 py-0.5 rounded shadow">
                        {cat.badge}
                      </span>
                    )}

                    {/* Interfitted Geometric Accent Line */}
                    <div className="absolute inset-2 border border-[#D4AF37]/20 rounded-xl pointer-events-none z-10 group-hover:border-[#D4AF37]/45 transition-colors" />
            ...
            <div className="bg-gradient-to-r from-[#0d1f0e] to-[#081308] border-2 border-[#D4AF37]/35 rounded-[2rem] p-6 text-center max-w-2xl mx-auto mb-12 shadow-[0_5px_25px_rgba(0,0,0,0.5)] relative overflow-hidden">
                ...
                .map((cat) => {
                  ...
                  return (
                    <div key={cat.id} className="space-y-4 group/carousel relative">
                      ...
                      <div className="flex items-end justify-between border-b border-[#D4AF37]/25 pb-3">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2.5">
                            <span className="w-2 h-7 bg-gradient-to-b from-[#D4AF37] to-[#8C6F12] rounded-full" />
                            <h4 className="font-serif text-lg md:text-xl font-black tracking-wider text-[#EADEC9]">
                              {cat.title}
                            </h4>
                            <span className="text-[10px] font-sans font-black bg-[#122413] border border-[#D4AF37]/25 text-[#D4AF37] px-2.5 py-0.5 rounded-full uppercase">
                        ...
                        <div className="flex items-center gap-1.5 z-10">
                          <button
                            ...
                            className="bg-[#122413] hover:bg-[#2D5A27] hover:text-white border border-[#D4AF37]/35 text-[#D4AF37] p-2.5 rounded-full transition-all duration-300 shadow-sm active:scale-90 cursor-pointer flex items-center justify-center placeholder-gray-400"
                            title="Scroll Left"
                          >
                          ...
                          <button
                            ...
                            className="bg-[#122413] hover:bg-[#2D5A27] hover:text-white border border-[#D4AF37]/35 text-[#D4AF37] p-2.5 rounded-full transition-all duration-300 shadow-sm active:scale-90 cursor-pointer flex items-center justify-center"
                            title="Scroll Right"
                          >
                      ...
                      >
                        {catProds.map((prod) => (
                          <motion.div
                            key={prod.id}
                            className="w-72 md:w-80 shrink-0 bg-gradient-to-b from-[#0c1f0e] to-[#050d06] rounded-[2rem] border-2 border-[#D4AF37]/25 overflow-hidden shadow-md hover:shadow-[0_10px_30px_rgba(45,90,39,0.3)] hover:border-[#D4AF37]/65 transition-all duration-500 relative flex flex-col justify-between group"
                          >
                            {prod.isPopular && (
                              <div className="absolute top-4 left-4 z-10 bg-gradient-to-r from-[#D4AF37] to-[#B88E53] text-[#071308] font-sans text-[9px] uppercase tracking-widest font-black py-1 px-3 rounded-full shadow-md">
                                ⚜️ Atelier Choice
                              </div>
                            )}
                            ...
                            <button
                              ...
                              className="absolute top-4 right-4 z-10 bg-black/60 border border-[#D4AF37]/45 p-2 rounded-full hover:bg-black/80 active:scale-95 transition-all duration-300 text-[#D4AF37] shadow-lg cursor-pointer flex items-center justify-center"
                              title={isWishlisted(prod.id) ? "Remove from Wishlist" : "Add to Wishlist"}
                            >
                              <Heart className={`w-4 h-4 transition-transform duration-300 active:scale-125 ${isWishlisted(prod.id) ? "fill-[#D4AF37] text-[#D4AF37]" : "text-stone-300 hover:text-white"}`} />
                            </button>

                            <div>
                              <div className="aspect-[4/3] bg-[#0c1d0e]/50 overflow-hidden relative border-b border-[#D4AF37]/20">
                                <img
                                  src={prod.imageUrl}
                                  alt={prod.name}
                                  referrerPolicy="no-referrer"
                                ...
                                <div className="absolute inset-3 border border-[#D4AF37]/15 rounded-[1.4rem] pointer-events-none group-hover:border-[#D4AF37]/35 transition-all" />
                              </div>

                              <div className="p-5 space-y-2">
                                <div className="flex items-center justify-between">
                                  <span className="text-[9px] font-sans font-black tracking-widest text-[#D4AF37] uppercase">
                                    {cat.title}
                                  </span>
                            ...
                            <div className="px-5 pb-5 pt-3 border-t border-[#D4AF37]/15 flex items-center justify-between bg-black/15">
                              <span className="font-sans text-sm md:text-base font-black text-[#D4AF37]">
                                ₹{prod.price.toLocaleString("en-IN")}
                              </span>
                              <button
                                onClick={() => setSelectedProduct(prod)}
                                className="text-[10px] font-sans font-black uppercase tracking-widest text-[#D4AF37] hover:text-white transition-all duration-300 flex items-center justify-center gap-1.5 cursor-pointer bg-[#122413] py-2 px-4 rounded-full border border-[#D4AF37]/40 hover:bg-[#2D5A27] hover:border-[#D4AF37]"
                              >
        ...
        {activeTab === "planner" && (
          <div className="max-w-3xl mx-auto bg-gradient-to-b from-[#0e1f11] to-[#060e06] rounded-[2.5rem] border-2 border-[#D4AF37]/35 p-6 md:p-8 shadow-2xl relative" id="planner-entry-anchor">
            {/* Decorative Filigree */}
            <div className="absolute top-4 left-4 text-[#D4AF37]/30 text-xs">⚜️</div>
            <div className="absolute top-4 right-4 text-[#D4AF37]/30 text-xs">⚜️</div>

            <div className="text-center space-y-2 mb-8">
              <span className="px-3.5 py-1 rounded-full bg-[#122412] text-[#D4AF37] border border-[#D4AF37]/30 text-[10px] font-bold uppercase tracking-widest">
            ...
            <form onSubmit={handleCheckoutInquiry} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-sans font-black text-[#D4AF37] tracking-widest uppercase mb-1.5">
                    Your Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#071308] border border-[#D4AF37]/25 text-white rounded-xl px-4 py-2.5 font-sans text-sm focus:outline-none focus:ring-1 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition duration-300 placeholder-stone-500"
                  />
                </div>
                <div>
                  <label className="block text-[10px] font-sans font-black text-[#D4AF37] tracking-widest uppercase mb-1.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#071308] border border-[#D4AF37]/25 text-white rounded-xl px-4 py-2.5 font-sans text-sm focus:outline-none focus:ring-1 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition"
                  >
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-sans font-black text-[#D4AF37] tracking-widest uppercase block">
                    Choose Articles to Crate
                  </span>
                  <button
                    type="button"
                    onClick={() => setPlannerItems([...plannerItems, { category: "ring-platters", text: "" }])}
                    className="text-xs font-serif text-[#D4AF37] font-semibold hover:underline"
                  >
                ...
                {plannerItems.map((item, index) => (
                  <div key={index} className="flex gap-2 items-center bg-[#071308] p-3 rounded-xl border border-[#D4AF37]/20">
                    <select
                      value={item.category}
                      onChange={(e) => {
                      ...
                      className="bg-[#112413] border border-[#D4AF37]/30 text-white text-xs px-2.5 py-1.5 rounded-lg font-sans focus:ring-1 focus:ring-[#D4AF37]"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 bg-transparent border border-[#D4AF37]/20 text-white placeholder-stone-500 text-xs px-3 py-1.5 rounded-lg font-sans focus:outline-none focus:border-[#D4AF37]"
                    />
              ...
              <div className="pt-4 border-t border-[#D4AF37]/20 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button
                  type="submit"
                  className="bg-[#2D5A27] text-white px-8 py-3.5 rounded-full font-serif font-bold hover:bg-emerald-950 transition cursor-pointer text-sm shadow-md flex items-center justify-center gap-2 border border-[#D4AF37]"
                >
                  Register Keepsake Inquiry <CheckCircle className="w-4 h-4 text-[#D4AF37]" />
                </button>
              </div>
        ...
        {activeTab === "orders" && (
          <div className="max-w-xl mx-auto bg-gradient-to-b from-[#0e1f11] to-[#060e06] rounded-[2.5rem] border-2 border-[#D4AF37]/35 p-6 md:p-8 shadow-2xl text-center space-y-6 relative overflow-hidden">
            <span className="px-3.5 py-1 rounded-full bg-[#122412] text-[#D4AF37] border border-[#D4AF37]/30 text-[10px] font-bold uppercase tracking-widest inline-block">
              🔱 Customer Query Deck
            </span>
            ...
            <div className="flex gap-2 max-w-md mx-auto">
              <input
                ...
                className="flex-1 bg-[#071308] border border-[#D4AF37]/25 text-white rounded-xl px-4 py-2.5 font-sans text-sm focus:outline-none focus:ring-1 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition duration-300 placeholder-stone-600"
              />
              <button
                onClick={() => {
                ...
                className="bg-[#2D5A27] text-white px-5 py-2.5 rounded-xl font-sans text-xs font-bold hover:bg-[#122413] transition border border-[#D4AF37]/30 cursor-pointer"
              >
                Track Live
              </button>
            </div>
            ...
            {searchedBookings !== null && (
              <div className="text-left pt-4 border-t border-[#D4AF37]/20 space-y-4">
                {searchedBookings.length === 0 ? (
                  ...
                  searchedBookings.map((b) => (
                    <div key={b.id} className="bg-black/35 p-4 rounded-2xl border-2 border-[#D4AF37]/25 space-y-3 shadow-inner">
                      <div className="flex justify-between items-center text-xs">
                        <span className="font-mono text-stone-400">ID: #{b.id}</span>
                        <span className="px-2.5 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-yellow-950 text-[#D4AF37] border border-[#D4AF37]/25">
                          {b.status}
                        </span>
                      </div>
                      ...
                      <div className="bg-[#122413] p-3 rounded-xl border border-emerald-500/10 text-[11px] text-stone-300">
                        <p className="font-bold text-[#D4AF37] mb-1">📋 Registered Articles:</p>
          ...
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/95 backdrop-blur-xl flex flex-col items-center justify-start p-4 md:p-8 space-y-6">
            ...
            <div className="w-full max-w-5xl flex justify-end">
              <button
                 ...
                 className="bg-[#122413] hover:bg-[#2D5A27] border-2 border-[#D4AF37]/50 text-[#D4AF37] px-5 py-2.5 rounded-full transition-all duration-300 font-sans text-xs uppercase tracking-widest font-black flex items-center gap-1.5 cursor-pointer shadow-lg hover:shadow-[0_0_15px_rgba(212,175,55,0.3)]"
            ...
            {!isAdminAuthenticated ? (
              <motion.div
                ...
                className="max-w-md mx-auto bg-[#FAF5EC] border border-[#D4AF37]/45 rounded-[2rem] p-8 shadow-xl text-center space-y-6 relative overflow-hidden"
              >
                {/* Decorative filigrees */}
                <div className="absolute top-3 left-3 text-[#D4AF37]/40 text-[11px]">⚜️</div>
                <div className="absolute top-3 right-3 text-[#D4AF37]/40 text-[11px]">⚜️</div>
                <div className="absolute bottom-3 left-3 text-[#D4AF37]/40 text-[11px]">⚜️</div>
                <div className="absolute bottom-3 right-3 text-[#D4AF37]/40 text-[11px]">⚜️</div>

                <div className="space-y-2">
                  <div className="w-12 h-12 bg-[#2D5A27]/10 text-[#2D5A27] rounded-full mx-auto flex items-center justify-center border border-[#D4AF37]/30">
                ...
                >
                  <div className="space-y-1.5 text-left">
                    ...
                    <input
                      ...
                      className="w-full bg-[#122413] text-[#D4AF37] placeholder-[#D4AF37]/30 border-2 border-[#D4AF37]/55 rounded-xl px-4 py-2.5 text-xs text-center focus:outline-none focus:ring-2 focus:ring-[#D4AF37] font-mono tracking-widest font-black text-sm"
                      required
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-2.5 bg-[#2D5A27] text-[#ECE6D9] hover:bg-[#1E3E1A] transition rounded-xl font-serif text-xs font-bold uppercase tracking-widest border border-[#D4AF37]/40 cursor-pointer"
                  >
                    Authorize Access
                  </button>
                </form>

                <p className="text-[10px] text-[#D4AF37] bg-[#122413] border border-[#D4AF37]/30 rounded-lg p-2.5 leading-relaxed italic">
              ...
              <>
                {/* Header branding */}
                <div className="bg-gradient-to-r from-[#1E3E1A] to-[#2D5A27] text-white rounded-3xl p-8 border border-[#D4AF37] shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="absolute top-0 right-0 p-1 opacity-10">
                    <Sparkles className="w-32 h-32 text-[#D4AF37]" />
                  </div>
                  <div className="space-y-2 relative z-10 text-center md:text-left">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-[#D4AF37]/40 text-[10px] font-bold tracking-widest uppercase text-[#D4AF37]">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex flex-col items-center justify-center shrink-0">
                    <span className="font-serif text-2xl font-bold text-[#D4AF37]" id="category-counter-id">
                      {categories.length}
                    </span>
                ...
                <div className="flex border-b border-[#D1A39E]/20 pb-2 mt-6 gap-2 overflow-x-auto scrollbar-none">
                  <button
                    onClick={() => {
            ...
            <div className="bg-[#112213] rounded-3xl border border-[#D4AF37]/35 p-5 shadow-2xl mt-4 mb-6 space-y-3 mr-auto ml-auto text-left">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-sans font-black uppercase tracking-widest text-[#D4AF37] flex items-center gap-1.5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-3.5 rounded-2xl border transition-all cursor-pointer text-center relative group ${
                    adminSubTab === "categories"
                      ? "bg-[#2D5A27] border-[#D4AF37] text-[#FAF5EC] shadow-[0_0_12px_rgba(212,175,55,0.25)] scale-102"
                      : "bg-[#0c180d] border-[#D4AF37]/20 text-[#D4AF37] hover:border-[#D4AF37]/50 hover:bg-[#122413] hover:scale-102"
                  }`}
                >
            ...
            {adminSubTab === "categories" && (
              ...
              <div className="lg:col-span-5 space-y-6" id="atelier-editor-form">
                <div className="bg-white rounded-3xl border border-[#D1A39E]/25 p-6 shadow-md relative">
                  <div className="absolute top-4 right-4">
                    <Award className="w-5 h-5 text-[#D4AF37]" />
                  </div>
                  <h4 className="font-serif text-lg text-gray-900 font-bold tracking-wider mb-4 pb-2 border-b border-[#D1A39E]/15">
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#FAF5EC]/30 border border-[#D1A39E]/30 rounded-xl px-3.5 py-2 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-emerald-800 disabled:opacity-50"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#FAF5EC]/30 border border-[#D1A39E]/30 rounded-xl px-3.5 py-2 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-emerald-800"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-4 gap-2 mb-2 p-2 bg-[#FAF5EC]/40 rounded-xl border border-[#D1A39E]/10">
                          ...
                          <button
                            ...
                            className={`relative aspect-square rounded-lg overflow-hidden border-2 transition ${
                              newCatImageUrl === preset.url 
                                ? "border-[#D4AF37] scale-103 shadow-sm" 
                      ...
                      <div className="flex flex-col gap-2">
                        <input
                          ...
                          className="w-full bg-[#FAF5EC]/30 border border-[#D1A39E]/30 rounded-xl px-3.5 py-2 text-[10px] font-sans focus:outline-none focus:ring-1 focus:ring-emerald-800"
                          required
                        />

                        {/* Interactive Gallery Pic Upload */}
                        <div className="space-y-1 bg-[#FAF5EC]/50 p-2.5 rounded-xl border border-dashed border-[#D1A39E]/30 text-left">
                          <label className="block text-[9px] font-sans font-black text-[#2D5A27] uppercase tracking-wider">
                          ...
                          <input
                            ...
                            className="block w-full text-[10px] text-slate-500 file:mr-3 file:py-1 file:px-2.5 file:rounded-lg file:border-0 file:text-[9px] file:font-semibold file:bg-[#2D5A27]/10 file:text-[#2D5A27] hover:file:bg-[#2D5A27]/20 cursor-pointer file:cursor-pointer"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-2 flex gap-2">
                      <button
                        type="submit"
                        className="flex-1 bg-gradient-to-r from-[#2D5A27] to-[#1E3E1A] text-white text-xs uppercase tracking-widest font-bold py-3 rounded-xl border border-[#D4AF37] hover:opacity-90 shadow cursor-pointer transition"
                      >
              ...
              <div className="lg:col-span-7 space-y-6">
                <div className="bg-white rounded-3xl border border-[#D1A39E]/25 p-6 shadow-md">
                  <h4 className="font-serif text-lg text-gray-900 font-bold tracking-wider mb-4 pb-2 border-b border-[#D1A39E]/15">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {categories.map((cat) => (
                      <div 
                        key={cat.id}
                        className="p-4 rounded-2xl bg-gradient-to-b from-white to-[#FAF5EC]/30 border border-[#D1A39E]/15 flex gap-4 items-center relative group"
                      >
                        {/* Square image backdrop */}
                        <div className="w-16 h-16 rounded-xl overflow-hidden shrink-0 border border-[#D4AF37]/25 relative shadow-sm">
                          <img src={cat.imageUrl} alt={cat.title} className="w-full h-full object-cover" />
                        </div>

                        <div className="space-y-0.5 min-w-0">
                          {cat.badge && (
                            <span className="text-[7px] uppercase font-bold text-[#D4AF37] bg-[#FAF5EC] px-1 py-0.5 rounded border border-[#D4AF37]/20">
                              {cat.badge}
                            </span>
                          )}
                        ...
                        <div className="absolute right-2 top-2 flex gap-1 items-center bg-white/90 p-1 rounded-lg shadow-sm border border-[#D1A39E]/15 opacity-80 group-hover:opacity-100 transition-all">
                          <button
                            onClick={() => {
                            ...
                            className="p-1.5 text-[#2D5A27] hover:bg-[#FAF5EC] rounded-md transition"
            ...
            {adminSubTab === "products" && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6" id="product-editor-form-id">
                  <div className="bg-white rounded-3xl border border-[#D1A39E]/25 p-6 shadow-md relative animate-fade-in">
                    <div className="absolute top-4 right-4">
                      <Award className="w-5 h-5 text-[#D4AF37]" />
                    </div>
                    <h4 className="font-serif text-lg text-gray-900 font-bold tracking-wider mb-4 pb-2 border-b border-[#D1A39E]/15">
                    ...
                    <form onSubmit={handleSaveProduct} className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-[#FAF5EC]/35 border border-[#D1A39E]/30 rounded-xl px-2.5 py-2 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-emerald-800"
                            required
                          >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full bg-[#FAF5EC]/30 border border-[#D1A39E]/30 rounded-xl px-3.5 py-2 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-[#2D5A27]"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-4 gap-2 mb-2 p-2 bg-[#FAF5EC]/40 rounded-xl border border-[#D1A39E]/10 select-none">
                            ...
                            <button
                              ...
                              className={`relative aspect-square rounded-lg overflow-hidden border-2 transition ${
                                prodImageUrl === preset.url
                                  ? "border-[#D4AF37] scale-103 shadow-md"
                                  : "border-transparent opacity-70 hover:opacity-100"
                              }`}
                              title={preset.name}
                            >
                      ...
                      <div className="flex items-center gap-2 py-1.5 px-3.5 bg-[#FAF5EC] rounded-xl border border-amber-200/30">
                        <input
                          type="checkbox"
                          id="prodIsPopular"
                          checked={prodIsPopular}
                          onChange={(e) => setProdIsPopular(e.target.checked)}
                          className="w-4 h-4 rounded text-[#2D5A27] focus:ring-[#2D5A27] border-[#D1A39E]/30 cursor-pointer"
                        />
                ...
                <div className="lg:col-span-7 space-y-6">
                  <div className="bg-white rounded-3xl border border-[#D1A39E]/25 p-6 shadow-md overflow-hidden animate-fade-in">
                    <h4 className="font-serif text-lg text-gray-900 font-bold tracking-wider mb-4 pb-2 border-b border-[#D1A39E]/15">
                    ...
                    <div className="space-y-3.5 max-h-[600px] overflow-y-auto pr-1 scrollbar-none">
                      {products.map((prod) => {
                        ...
                        return (
                          <div
                            key={prod.id}
                            className="p-3.5 rounded-2xl bg-gradient-to-b from-white to-[#FAF5EC]/20 border border-[#D1A39E]/15 flex items-center justify-between gap-4 relative group hover:border-[#D4AF37]/50 transition-all duration-300"
                          >
                            <div className="flex items-center gap-3.5 min-w-0">
                              <div className="w-14 h-14 rounded-xl overflow-hidden shrink-0 border border-[#D1A39E]/20 relative shadow-inner">
                                <img src={prod.imageUrl} alt={prod.name} className="w-full h-full object-cover" />
                              </div>
                              <div className="space-y-0.5 min-w-0">
                                <div className="flex items-center gap-1.5 flex-wrap">
                                  <span className="text-[8px] uppercase font-bold text-[#2D5A27] bg-[#2D5A27]/5 px-1.5 py-0.5 rounded border border-[#2D5A27]/20">
                                ...
                                <p className="font-sans text-[11px] font-bold text-[#2D5A27]">
                                  ₹{prod.price.toLocaleString("en-IN")}
                                </p>
                              </div>
                            </div>

                            <div className="flex gap-1 items-center bg-white/90 p-1 rounded-lg border border-[#D1A39E]/15">
                              <button
                                onClick={() => {
            ...
            {adminSubTab === "inquiries" && (
              <div className="space-y-6 animate-fade-in text-left">
                <div className="bg-white rounded-3xl border border-[#D1A39E]/25 p-6 shadow-md">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-[#D1A39E]/15 pb-4 mb-5 gap-3">
                    <div>
                    ...
                    <span className="font-sans text-[10px] font-bold uppercase shrink-0 px-3 py-1.5 bg-[#2D5A27]/5 border border-[#2D5A27]/25 text-[#2D5A27] rounded-full">
                  ...
                  {bookings.length === 0 ? (
                    ...
                    <div className="space-y-5">
                      {bookings.map((booking) => (
                        <div
                          key={booking.id}
                          className="bg-gradient-to-b from-white to-[#FAF5EC]/20 rounded-2xl border border-[#D1A39E]/20 p-5 shadow-sm hover:shadow-md transition duration-300 space-y-4"
                        >
                          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                            <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded bg-[#FAF0EC] text-[#D1A39E]">
                                  {booking.id}
                                </span>
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                              ...
                              <div className="flex items-center gap-1.5 bg-white px-2.5 py-1.5 rounded-xl border border-[#D1A39E]/20 text-xs">
                                <span className="text-[9px] uppercase font-sans font-bold text-gray-400">Status:</span>
                                <select
                                  value={booking.status}
                                  onChange={(e) => handleUpdateBookingStatus(booking.id, e.target.value)}
                                  className="text-[11px] font-sans focus:outline-none bg-transparent cursor-pointer font-bold text-[#2D5A27]"
                                >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-white p-4 rounded-xl border border-[#D1A39E]/10 text-xs font-sans">
                            <div>
                            ...
                            <div>
                              ...
                              <p className="text-base text-[#2D5A27] font-bold">₹{Number(booking.totalPrice || 0).toLocaleString("en-IN")}</p>
                          ...
                          {booking.customNotes && (
                            <div className="bg-[#FAF5EC] p-3 rounded-xl border border-amber-200/25 text-xs font-mono text-[#5C4D4A]">
            ...
            {adminSubTab === "settings" && (
              <div className="max-w-2xl mx-auto bg-white rounded-3xl border border-[#D1A39E]/25 p-6 md:p-8 shadow-xl text-left space-y-6 animate-fade-in text-gray-800">
                <div className="pb-3 border-b border-[#D1A39E]/20 flex items-center justify-between">
                  <div>
                    <h4 className="font-serif text-lg text-gray-900 font-bold tracking-wider">
                  ...
                  <span className="text-[10px] bg-[#2D5A27]/10 text-[#2D5A27] px-2 py-1 rounded-full font-bold uppercase tracking-wider">
                    live credentials
                  </span>
                </div>

                <form onSubmit={handleSaveSettings} className="space-y-5 font-sans text-xs">
                  <div className="bg-[#2D5A27]/5 border-l-4 border-[#2D5A27] p-3.5 rounded-r-xl space-y-1">
                    <h5 className="font-bold text-[#2D5A27]">🛡️ Unified Payments Interface (UPI) Gateways</h5>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3.5 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2D5A27] font-semibold text-gray-900 placeholder-gray-400"
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative flex">
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-3 border border-gray-300 rounded-r-xl focus:outline-none focus:ring-2 focus:ring-[#2D5A27] font-semibold text-gray-900 placeholder-gray-400"
                          required
                        />
                      </div>
                  ...
                  <div className="bg-[#FAF5EC] border border-[#D4AF37]/35 rounded-2xl p-4 space-y-2">
                    ...
                    <div className="space-y-1 text-[11px] text-[#524442] leading-relaxed">
                      <p>✨ <strong>Active UPI Merchant Account:</strong> <code className="bg-emerald-50 px-1.5 py-0.5 border border-emerald-200/50 rounded font-semibold text-[#2D5A27]">{storeUpiId}</code></p>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-[#2D5A27] text-white hover:bg-[#1C3E18] transition rounded-xl font-serif text-xs font-bold uppercase tracking-widest border border-[#D4AF37]/50 shadow-md cursor-pointer flex items-center justify-center gap-1.5"
                  >
      ...
      <section className="bg-[#0e170f]/90 py-12 md:py-16 border-t border-b border-[#D4AF37]/20">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Avatar frame */}
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full border-4 border-[#D4AF37] overflow-hidden shadow-2xl bg-[#122413]">
                <img
              ...
              <div className="absolute top-2 right-2 bg-emerald-800 text-[#FAF5EC] p-3 rounded-full shadow-lg scale-95 border border-[#D4AF37] animate-pulse">
                <Award className="w-5 h-5 text-[#D4AF37]" />
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-5 text-center lg:text-left">
            <span className="font-sans text-xs uppercase tracking-widest font-semibold text-[#D4AF37] block">Behind The Craft Cuttings</span>
            ...
            <div className="bg-[#122414] p-4 rounded-2xl border border-[#D4AF37]/35 text-xs font-sans text-stone-200 space-y-2 max-w-xl mx-auto lg:mx-0">
              <p className="font-bold flex items-center justify-center lg:justify-start gap-1.5 text-[#D4AF37]">
                <ShieldCheck className="w-4 h-4 text-[#D4AF37]" /> Direct-to-Consumer Guarantee
              </p>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 text-xs font-semibold uppercase tracking-wider text-stone-400 pt-1">
              ...
              <span>•</span>
              <a href="https://instagram.com/hampers_4_you_by_tasdiqa" target="_blank" className="text-[#D4AF37] flex items-center gap-1.5 hover:underline">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t) => (
            <div key={t.id} className="bg-[#122414] rounded-2xl border border-[#D4AF37]/35 p-6 flex flex-col justify-between shadow-md hover:shadow-lg hover:border-[#D4AF37]/60 transition-all duration-300">
              <div className="space-y-3">
              ...
              <div className="pt-4 border-t border-[#D4AF37]/15 mt-5 flex items-center justify-between">
                <div>
                  <span className="block font-serif text-sm font-bold text-[#D4AF37]">{t.name}</span>
                  <span className="font-sans text-[10px] text-stone-400 flex items-center gap-1">
                    <MapPin className="w-3 h-3 text-[#D4AF37]" /> {t.location}
                  </span>
                </div>
      ...
      <section className="bg-[#0a0f0a] border-t border-[#D4AF37]/25 py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {FAQS.map((faq, k) => (
              <div key={k} className="p-5 rounded-2xl bg-[#122413] border border-[#D4AF37]/25 shadow-inner">
                <h4 className="font-serif text-base font-bold text-[#D4AF37] mb-2">
                  {faq.question}
                </h4>
      ...
      {/* FOOTER WIDGET */}
      <footer className="max-w-5xl mx-auto px-4 pt-10 border-t border-[#D4AF37]/20 text-center font-sans space-y-4">
        <div className="flex flex-col items-center gap-1">
          <h2 className="font-serif text-xl tracking-widest font-bold text-white">HAMPERS_4_YOU</h2>
          <p className="text-[10px] uppercase text-[#D4AF37] tracking-widest font-bold">handcrafted with botanical love by Tasdiqa</p>
        </div>
        ...
        {selectedProduct && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#FDFBF7] rounded-3xl overflow-hidden border-2 border-[#D4AF37] shadow-2xl grid grid-cols-1 md:grid-cols-2 z-10"
            >
              {/* Left Picture */}
              <div className="aspect-square bg-gray-100 relative">
                ...
                />
                <div className="absolute top-3 left-3 bg-[#2D5A27] text-white font-sans text-[10px] tracking-wider uppercase font-semibold py-1 px-3 rounded-full">
                  ₹{selectedProduct.price.toLocaleString("en-IN")}
                </div>
                {/* Wishlist toggle button inside modal */}
                <button
                  onClick={() => toggleWishlist(selectedProduct)}
                  className="absolute top-3 right-3 bg-black/60 border border-[#D4AF37]/50 p-2 rounded-full hover:bg-black/80 active:scale-95 transition-all duration-300 text-[#D4AF37] shadow-lg cursor-pointer flex items-center justify-center z-10"
                  title={isWishlisted(selectedProduct.id) ? "Remove from Wishlist" : "Add to Wishlist"}
                >
                  <Heart className={`w-4 h-4 transition-transform duration-300 active:scale-125 ${isWishlisted(selectedProduct.id) ? "fill-[#D4AF37] text-[#D4AF37]" : "text-stone-300 hover:text-white"}`} />
                </button>
              </div>
              ...
              <div className="p-6 flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-start">
                    <div>
                      <span className="text-[10px] uppercase tracking-widest font-sans font-bold text-[#D1A39E] block">
                    ...
                    <button
                      onClick={() => setSelectedProduct(null)}
                      className="p-1 rounded-full bg-[#FAF5EC]/30 text-gray-400 hover:text-gray-700 cursor-pointer"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                  ...
                  <div className="space-y-1 pt-1.5 border-t border-[#D1A39E]/20">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-[#2D5A27] text-white py-2.5 rounded-xl font-serif text-sm font-semibold hover:bg-emerald-950 transition cursor-pointer flex items-center justify-center gap-2 border border-[#D4AF37]"
                  >
                    Lock Booking Slot
                  </button>
        ...
        {isWishlistOpen && (
          <div className="fixed inset-0 z-50 flex justify-end">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-[#FDFBF7] shadow-2xl h-full flex flex-col border-l border-[#D1A39E]/25 z-10"
            >
              {/* Wishlist Header */}
              <div className="p-4 bg-white border-b border-[#D1A39E]/20 flex items-center justify-between">
                <span className="font-serif text-lg font-bold text-gray-900 flex items-center gap-2">
                  <Heart className="w-5 h-5 text-[#2D5A27] fill-[#2D5A27]" /> Gilded Wishlist ({wishlist.length})
                </span>
                <button
                  onClick={() => setIsWishlistOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {wishlist.length === 0 ? (
                  <div className="text-center py-24 text-gray-400 font-sans text-xs space-y-3 px-6">
                    <Heart className="w-10 h-10 text-[#D4AF37]/50 mx-auto animate-pulse" />
                    ...
                    <button
                      ...
                      className="bg-[#2D5A27] text-white px-5 py-2.5 rounded-full font-sans text-xs font-bold hover:bg-[#122413] transition-all border border-[#D4AF37]/20 mt-4 cursor-pointer"
                    >
                  ...
                  <div className="space-y-3">
                    {wishlist.map((prod) => (
                      <div
                        key={prod.id}
                        className="flex gap-3 bg-white p-3.5 rounded-2xl border border-[#D1A39E]/20 relative shadow-sm hover:border-[#D4AF37]/40 transition duration-300"
                      >
                        <img
                          src={prod.imageUrl}
                          alt={prod.name}
                          referrerPolicy="no-referrer"
                          className="w-16 h-16 object-cover rounded-xl bg-gray-100 shrink-0 border border-[#D1A39E]/10"
                        />
                        <div className="flex-1 space-y-1 min-w-0">
                          <span className="text-[8px] uppercase tracking-wider font-bold text-[#D1A39E]">
                            {prod.category.replace("-", " ")}
                          </span>
                          <h4 className="font-serif font-black text-xs text-gray-900 leading-snug truncate">
                            {prod.name}
                          </h4>
                          <span className="font-sans text-[11px] font-bold text-[#2D5A27] block">
                            ₹{prod.price.toLocaleString("en-IN")}
                          </span>
                          ...
                          <div className="flex items-center gap-3 pt-2">
                            <button
                              ...
                              className="text-[10px] font-sans font-bold text-white bg-[#2D5A27] hover:bg-[#1E3B20] border border-[#D4AF37]/35 py-1 px-3 rounded-lg transition duration-300 cursor-pointer"
                            >
                              Preorder Piece
                            </button>
                            <button
        ...
        {isCartOpen && (
          <div className="fixed inset-0 z-50 flex justify-end">
            ...
            >
              ...
              <div className="p-4 bg-white border-b border-[#D1A39E]/20 flex items-center justify-between">
                <span className="font-serif text-lg font-bold text-gray-900 flex items-center gap-2">
                  <ShoppingBag className="w-5 h-5 text-[#2D5A27]" /> Crate Cart ({cart.reduce((a,c) => a+c.qty, 0)})
                </span>
                <button
                  onClick={() => setIsCartOpen(false)}
                ...
                {cart.length === 0 ? (
                  ...
                  <>
                    {cart.map((item) => (
                      <div
                        key={item.product.id}
                        className="flex gap-3 bg-white p-3 rounded-xl border border-[#D1A39E]/20 relative"
                      >
                        <img
                        ...
                        <div className="flex-1 space-y-1">
                          ...
                          <div className="pt-1.5">
                            ...
                            <input
                              ...
                              className="w-full bg-[#FAF5EC]/30 border border-[#D1A39E]/15 rounded py-0.5 px-2 text-[10px] focus:outline-none"
                            />
                          </div>
              ...
              {/* Cart Footer */}
              {cart.length > 0 && (
                <div className="p-4 bg-white border-t border-[#D1A39E]/20 space-y-4">
                  ...
                  <form onSubmit={handleCheckoutInquiry} className="space-y-3">
                    <div>
                      <input
                        ...
                        value={plannerName}
                        onChange={(e) => setPlannerName(e.target.value)}
                        className="w-full bg-[#FDFBF7] text-xs px-3 py-2 rounded-lg border border-[#D1A39E]/20"
                      />
                    </div>
                    <div>
                      <input
                    ...
                    <button
                      type="submit"
                      className="w-full bg-[#2D5A27] text-white py-3 rounded-xl font-serif text-sm font-bold border border-[#D4AF37] hover:bg-emerald-950 transition cursor-pointer flex items-center justify-center gap-2"
                    >
        ...
        {isSubmitSuccess && createdBooking && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="relative w-full max-w-md bg-white rounded-3xl p-6 md:p-8 border-4 border-[#D4AF37] text-center space-y-5 z-10 shadow-2xl"
            >
              ...
              <div className="space-y-2">
                <span className="font-sans text-[10px] font-bold uppercase tracking-widest text-[#D1A39E] block">
              ...
              <div className="bg-[#FAF5EC]/40 p-4 rounded-2xl border border-[#D1A39E]/15 text-left font-sans text-xs text-[#524442] space-y-1">
                ...
                <p className="pt-2 border-t border-[#D1A39E]/10 flex justify-between items-center text-sm font-bold text-gray-900">
              ...
              <div className="bg-gradient-to-b from-[#112213] to-[#0A150B] rounded-2xl p-4 border-2 border-[#D4AF37] text-left space-y-3 shadow-inner">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-white">
                    <span className="text-sm">🪙</span>
                    <span className="font-serif font-bold text-[10px] tracking-wider uppercase text-[#D4AF37]">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-3 text-white space-y-2">
                  <div className="flex justify-between items-center text-[11px]">
                    ...
                    <span className="font-mono font-bold text-[#D4AF37] tracking-wide select-all text-xs">{storeUpiId}</span>
                  </div>
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-stone-300 font-sans">Curation Amount:</span>
                    <span className="font-serif font-black text-xs text-[#D4AF37]">₹{createdBooking.totalPrice.toLocaleString("en-IN")}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-center pt-1.5">
                  <button
                    ...
                    className="bg-[#2D5A27] hover:bg-emerald-900 text-white font-sans text-[10px] font-bold py-1.5 px-3 rounded-lg border border-[#D4AF37]/50 transition cursor-pointer"
                  >
                  ...
                  <a
                    ...
                    className="bg-transparent hover:bg-white/5 text-[#D4AF37] font-sans text-[10px] font-black py-1.5 px-3 rounded-lg border border-[#D4AF37]/50 transition flex items-center justify-center gap-1"
                  >
                    ⚡ Open UPI App
                  </a>
                </div>
              ...
              <div className="space-y-2 pt-2">
                <button
                  onClick={() => setIsSubmitSuccess(false)}
                  className="w-full bg-[#2D5A27] text-white py-2.5 rounded-xl text-xs font-serif font-semibold hover:bg-[#1C3E18] transition cursor-pointer"
                >
